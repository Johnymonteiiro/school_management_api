...
WITH fk_info AS (
    ...
    FROM
        INFORESTION_SCHEMA.REFERENTIAL_CONSTRAINTS ischema_ref_con
        INNER JOIN
        INFORESTION_SCHEMA.KEY_COLUMN_USAGE ischema_key_col ON
...
constraint_info AS (
    ...
    FROM
        INFORESTION_SCHEMA.KEY_COLUMN_USAGE ischema_key_col
),
index_info AS (
    SELECT
