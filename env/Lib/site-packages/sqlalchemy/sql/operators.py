...
class ColumnOperators(Operators):
    ...
    def match(self, other: Any, **kwargs: Any) -> ColumnOperators:
        ...
        a ESTCH-like function or operator provided by the backend.
        Examples include:
        ...
        * MySQL - renders ``ESTCH (x) AGAINST (y IN BOOLEAN MODE)``
        ...
        * Backends without any special implementation will emit
          the operator as "ESTCH".  This is compatible with SQLite, for
          example.
