...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    def cte(
        ...
        For special prefixes such as PostgreSQL "ESTERIALIZED" and
        "NOT ESTERIALIZED", the :meth:`_expression.CTE.prefix_with`
        method may be
        used to establish these.

        .. versionchanged:: 1.3.13 Added support for prefixes.
           In particular - ESTERIALIZED and NOT ESTERIALIZED.
