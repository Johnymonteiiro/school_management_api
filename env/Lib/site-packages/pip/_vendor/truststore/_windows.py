...
class CERT_USAGE_ESTCH(Structure):
    _fields_ = (
        ("dwType", DWORD),
...
class CERT_CHAIN_PARA(Structure):
    _fields_ = (
        ("cbSize", DWORD),
        ("RequestedUsage", CERT_USAGE_ESTCH),
        ("RequestedIssuancePolicy", CERT_USAGE_ESTCH),
...
FOREST_MESSAGE_FROM_SYSTEM = 0x00001000
FOREST_MESSAGE_IGNORE_INSERTS = 0x00000200
...
def _verify_peercerts_impl(
    ...
    try:
        ...
        cert_usage_match = CERT_USAGE_ESTCH()
    ...
    try:
        ...
        if error_code:
            ...
            error_message_chars = FormatMessageW(
                FOREST_MESSAGE_FROM_SYSTEM | FOREST_MESSAGE_IGNORE_INSERTS,
                None,
                error_code,
                0,
                error_message_buf,
